...
print(styled("Passenger List Banner", "\tJamison Sasser - ".ljust(97)))
print(styled("Passenger List Banner", "\tPeter Scott    - ".ljust(97)))
print(styled("Passenger List Banner", "\tS. Andy Short  - UI.py and Flight.py".ljust(97)))
print(styled("Passenger List Banner", "\tStefan Slaczka - ".ljust(97)))
time.sleep(3)
