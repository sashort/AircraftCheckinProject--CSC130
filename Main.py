...
main_menu = Menu("Main Menu", {1: "Book Seats",
                               ...
                               'X': "Exit"}, exit_value='X')
while True:
    main_menu.menu_item(1).set_disabled(boarded())
    main_menu.menu_item(2).set_disabled(check_in_begun() or boarded())
    main_menu.menu_item(3).set_disabled(not check_in_begun() or boarded())
    main_menu.menu_item(4).set_disabled(len(get_my_passenger_list()) == 0 or boarded())
    main_menu.menu_item(5).set_disabled(boarded())
    main_menu.menu_item(6).set_disabled(not check_in_begun() or boarded())
